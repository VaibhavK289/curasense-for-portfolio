...
export const spacingAliases = {
  ...
  "component-sm": spacing[2],    // 8px - compact
  "component-md": spacing[3],    // 12px - default
  "component-lg": spacing[4],    // 16px - comfortable
  "component-xl": spacing[6],    // 24px - spacious
  
  // Section spacing
  "section-xs": spacing[4],      // 16px
  ...
  // Page spacing
  "page-gutter": spacing[6],     // 24px - mobile
  "page-gutter-lg": spacing[8],  // 32px - desktop
} as const;
